...
func RegisterStarterRoutes(rg *gin.RouterGroup, handler *StarterHandler, searchService *application.StarterSearchService) {
	...
	route.PUT("/:domain", response.Wrap(handler.UpdateStarter))
