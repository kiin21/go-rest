...
const (
	StarterIndexName = "starters"
)

// ElasticsearchStarterRepository implements StarterSearchRepository using Elasticsearch
...
// Search performs search query on Elasticsearch
