...
type StarterRepository interface {
	...
	List(ctx context.Context, filter model.StarterListFilter, pg httputil.ReqPagination) ([]*model.Starter, int64, error)
	SearchByKeyword(ctx context.Context, keyword string, filter model.StarterListFilter, pg httputil.ReqPagination) ([]*model.Starter, int64, error)
...
type StarterSearchRepository interface {
	Search(ctx context.Context, query string, filter model.StarterListFilter, pg httputil.ReqPagination) ([]*model.Starter, int64, error)
