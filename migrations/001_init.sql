...
ALTER TABLE `departments`
    ADD CONSTRAINT `fk_dep_bu`
        FOREIGN KEY (`business_unit_id`) REFERENCES `business_units` (`id`)
            ON DELETE SET NULL ON UPDATE CASCADE,  -- Changed to SET NULL for flexibility
...
VALUES (1, 'VNG Corporation') ON DUPLICATE KEY
UPDATE name =
VALUES (name);
...
VALUES (1, 'minhlh', 'Le Hoang Minh', 'minhlh@vng.com.vn', '(+84) 0913875329', '0913875329',
        'Founder, Chairman of VNG', NULL, NULL),
       (2, 'kelly', 'Kelly Le', 'kelly@vng.com.vn', '(+84) 0919392288', '0919392288',
        'Chief Executive Officer', NULL, NULL),
       (3, 'chill', 'Chi Le', 'chill@vng.com.vn', '(+84) 08607548666', '08607548666',
        'CEO of Zalopay', NULL, NULL),
       (4, 'thanhnl', 'Nguyen Le Thanh', 'thanhnl@vng.com.vn', '(+84) 0764450920', '0764450920 (6200)',
       ...
       (9, 'duydh2', 'Dang Huu Duy', 'duydh2@vng.com.vn', '(+84) 0904157432', '0904157432',
        'Lead Software Engineer', NULL, NULL),
       (10, 'khoapda', 'Pham Dinh Anh Khoa', 'khoapda@vng.com.vn', '(+84) 0359754697', '0359754697',
        'Software Intern', NULL, NULL),
       (11, 'duyct', 'Cao Tien Duy', 'duyct@vng.com.vn', '(+84) 0908608731', '0908608731',
        'Senior Data Engineer', NULL, NULL),
       (12, 'trungnk', 'Nguyen Kim Trung', 'trungnk@vng.com.vn', '(+84) 0908226847', '0908226847',
        'Senior Data Engineer', NULL, NULL),
       (13, 'trungnk', 'Nguyen Kim Trung', 'trungnk@vng.com.vn', '(+84) 0908226847', '0908226847',
        'Senior Data Engineer', NULL, NULL) ON DUPLICATE KEY
UPDATE domain =
VALUES (domain);

-- Insert BUs (without leader first to avoid FK constraint)
INSERT INTO business_units (id, name, shortname, company_id, leader_id)
VALUES (1, 'VNGGames', 'VNGG', 1, NULL),
       (2, 'Zalo', 'ZALO', 1, NULL),
       (3, 'Zalopay', 'ZLP', 1, NULL),
       (4, 'Digital Business', 'DB', 1, NULL) ON DUPLICATE KEY
UPDATE name =
...
VALUES (1, NULL, NULL, 'Senior Management Team', 'SMT', NULL),
       ...
       (12, 5, NULL, 'Game Data Studio', 'GDS', NULL) ON DUPLICATE KEY
UPDATE full_name =
VALUES (full_name), shortname =
VALUES (shortname);
...
END
WHERE domain IN ('minhlh', 'kelly', 'chill', 'thanhnl', 'khaivq', 'hawkinsp', 'vietph',
                 'locth2', 'duydh2', 'khoapda', 'duyct', 'trungnk');
...
END
WHERE domain IN ('kelly', 'chill', 'thanhnl', 'khaivq', 'hawkinsp', 'vietph',
                 'locth2', 'duydh2', 'khoapda', 'duyct', 'trungnk');
